...
pprint module and function pprint    
pprint.pprint()
...
because the string is enclosed in double quotations, so the single quotation doesnt close the string

# 5. If you don’t want to put \n in your string, how can you write a string with newlines in it?
"""by using a multiline string with triple quotes, 
which counts quotes, tabs, 
and new lines as part of the string."""
...
.rjust(int(length of string),"fill character")   or .rjust(int(length of string))
.ljust(int(length of string),"fill character")   or .ljust(int(length of string))
.center(int(length of string),"fill character")  or .center(int(length of string))

# 10. How can you trim whitespace characters from the beginning or end of a string?
.lstrip()   trims white space from beginning of string
.rstrip()   trims white space from end of string
.strip()    removes white space from beginning and end of string
